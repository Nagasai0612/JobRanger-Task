  ...
  return (
    <div className="job-portal">
      ...
      <div className="status">
        <marquee className="status-text">Shivam got selected for the job!</marquee>
        <marquee className="status-text">Balakrishna Place in Infosys</marquee>
  <marquee className="status-text">GopalKrishna placed in Google</marquee>
  <marquee className="status-text">Varun selected in NTT Data</marquee>
      </div>
